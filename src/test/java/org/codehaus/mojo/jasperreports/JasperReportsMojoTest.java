 ...
 * @version $Revision$
 */
public class JasperReportsMojoTest extends TestCase {
    public void testClasspathBuildingAddsStuffIfNeeded() {
        ...
        assertEquals(
                "foo" + File.pathSeparator + "bar" + File.pathSeparator + "baz",
                mojo.buildClasspathString(fakeElements, null));
        assertEquals(
                "foo" + File.pathSeparator + "bar" + File.pathSeparator + "baz" + File.pathSeparator + "bingo",
